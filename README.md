...
<p>
	<ol>
		<li>Clone the project with <code>git clone https://github.com/hydrogen-dev/web3-sample-app.git</code>.</li>
		...
		<li>Run <code>node server/index.js</code> to start the app at port <code>3000</code>.</li>
